...
export default async function HaulPage({
  ...
  // Identity from the session, not the URL — same ownership rule as the write
  // actions (view-as resolves to the impersonated friend).
      ...
      {items.length === 0 ? (
        ...
        <>
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {!locked && !unavailable && (
                      <div className="mt-1.5">
                        <QuantityStepper itemId={item.id} quantity={qty(item)} />
                      </div>
                    )}
                    {locked && qty(item) > 1 && (
                  ...
                  <div className="shrink-0 text-right">
                    ...
                    {(!locked || unavailable) && (
                      <form action={removeFromHaul.bind(null, item.id)}>
                        <button
                          type="submit"
          ...
          <div className="ml-auto w-full max-w-sm space-y-1.5 text-sm">
            ...
            {editable.length > 0 && (
              <form action={approveHaul} className="pt-3">
